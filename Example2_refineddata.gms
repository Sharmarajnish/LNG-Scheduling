...
SETS
P PARCELS TO BE UNLOADED BY VLCCs or ULCCs /P1*P20/
*VCP(V,P) SHIP CARRYING PARCEL P /V1.(P1*P3),V2.(P4*P5),V3.(P6*P7)/
LP(P) /P4, P8, P12, P16, P20/
K SLOTS /1*5/
S TANKS /S1*S4/
SK(S,K) /S1.(1*5), S2.(1*5), S3.(1*5),S4.(1*5)/
SKL(S,K)/S1.5, S2.5, S3.5, S4.5/
PS(P,S) /(P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19,P20).S1, (P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20).S2, (P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20).S3,(P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20).S4/
O ORDERS /O1*O16/
OS(S,O) ORDERS FROM TANKS / S1.(O4,O5, O9, O13), S2.(O2, O8,O12, O14, O16), S3.(O3,O6, O10, O15), S4.(O1, O7, O11)/
...
Sets
PPS(PP,S) /(P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20).S1, (P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20).S2, (P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20).S3,(P1,P2,P3,P4,P5,P6,P7,P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20).S4/
OOS(S,OO)/ S1.(O4,O5, O9, O13), S2.(O2, O8,O12, O14, O16), S3.(O3,O6, O10, O15), S4.(O1, O7, O11)/
SKk(S,kK)/S1.5, S2.5, S3.5, S4.4/
PARAMETERS
NX /1/
...
ETA(P) ESTIMATED TIME OF ARRIVAL OF VLCC OR ULCC/P1 5, P2 14.667, P3 21.524, P4 31.524, P5 43.10, P6 53.10, P7 64.702, P8 71.254, P9 80.81, P10 91.41, P11 107.73, P12 119.43, P13 125, P14 138.81, P15 150.85, P16 165.419, P17 176.83, P18 184.642, P19 190.017, P20 206.817/

STD(P) STIPULATED TIME OF DEPARTURE OF VLCC OR ULCC- UPPER LIMIT IN HOURS /P4 60, P8 100, P12 150, P16 200, P20 250/

IPFU(P) INCOMING PUMPING RATE OF PARCELS IN KBBL PER HOUR/P1 30, P2 35, P3 25, P4 22, P5 19, P6 24, P7 25, P8 29, P9 27, P10 25, P11 19, P12 23.5, P13 21, P14 22, P15 19.5,P16 18.4, P17 32, P18 32, P19 25, P20 22/

Q(P) VOLUME OF EACH PARCEL /P1 290, P2 240, P3 250, P4 230, P5 220, P6 240, P7 290, P8 190, P9 258, P10 265, P11 310, P12 275, P13 390, P14 365, P15 384, P16 310, P17 250, P18 300, P19 320, P20 350/
...
RQ(O) UPPER LIMIT REQUISITE VOLUME OF EACH ORDER /O1 550, O2 420, O3 420, O4 410, O5 490, O6 380, O7 390, O8 440, O9 325, O10 370, O11 390, O12 285,  O13 490, O14 420, O15 380, O16 450/

DDL(O) DELIVERY DEMAND DUE DATE OF ORDERS- LOWER LIMIT IN HOURS /O1 16, O2 40, O3 55, O4 80, O5 110, O6 140, O7 160, O8 180, O9 200, O10 225, O11 250, O12 270, O13 300, O14 340, O15 350, O16 360 /
*
DDU(O) DELIVERY DEMAND DUE DATE OF ORDERS-UPPER LIMIT IN HOURS /O1 32, O2 60, O3 70, O4 98, O5 122, O6 159, O7 170, O8 195, O9 220, O10 245,O11 260, O12 295, O13 320, O14 360, O15 370, O16 400/

I0(S) /S1 600, S2 500, S3 520, S4 550/

DC(P) DEMURRAGE COST ASSOCIATED WITH EACH SHIP IN $ PER HOUR/P4 120, P8 150, P12 100, P16 100, P20 130/
*/P2 100/
*
DCO(O) DEMURRAGE COST ASSOCIATED WITH EACH ORDER IN $ PER HOUR /O1 20, O2 13, O3 19, O4 22, O5 14, O6 15, O7 15, O8 16, O9 20, O10 12, O11 21, O12 19, O13 22, O14 23, O15 24, O16 25/
ECO(O) DEMURRAGE COST ASSOCIATED WITH EACH ORDER IN $ PER HOUR /O1 11, O2 13, O3 11, O4 12, O5 14, O6 15, O7 15, O8 16, O9 10, O10 12, O11 11, O12 13, O13 12, O14 13, O15 14, O16 15/
